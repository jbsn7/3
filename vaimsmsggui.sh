...
zenity --info --width=200 --title Vaim-sms v2.1 --text "Attacking starting"
menu
...
upp | zenity --progress --auto-close --width=400 --height=250 --title "updating vaim-sms-gui v3..."
zenity --info --width=200 --title Vaim-sms v2.1 --text "Update Successfully"
sudo bash VaimSMSv3.sh
}
...
mai=$(zenity --title "Vaim-sms v2.9" --width=400 --height=250 --list --column Select --column  Options 1 Attack 2 Update 3 Exit --height=250 --width=300 --text "This is a bomber tool" 2>&1)
